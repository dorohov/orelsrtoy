...
$(function() {
	...
	var 
		map_area = $('#map-realized'),
		__object_data = JSON.parse(map_area.attr('data-coords') || '{}')
	;
	/*
	{
		"title" : "",
		"center" : [52.991885, 36.038617],
		"zoom" : 15,
		"placemark" : [52.992856, 36.041289],
		"coordinates" : [
			[
	...
	*/
	...
	var map_area_center = {		
			center: __object_data.center,//[52.991885, 36.038617], // расположение района
			zoom: __object_data.zoom,//15,
	...
	var initYandexMapGlonass = function() {
		...
		map_area_block = new ymaps.Map('map-realized', map_area_center, {
			//searchControlProvider: 'yandex#search'
		});

		 // Создание метки со сложной фигурой активной области.
		var polygonLayout = ymaps.templateLayoutFactory.createClass('<div class="property-adv__map-container"><div class="property-adv__map-icon"><svg class="icon-svg icon-area-map" role="img"><use xlink:href="/bitrix/templates/azbn7theme/img/svg/sprite.svg#area-map"></use></svg></div><div class="property-adv__map-layout">' + __object_data.title + '</span></div></div>');
		var map_placemark = new ymaps.Placemark(__object_data.placemark, {
			hintContent: ''
		}, {
		...
		var myGeoObject = new ymaps.GeoObject({
			geometry: {
				type: "Polygon",
				coordinates: __object_data.coordinates,
				fillRule: "nonZero"
			},
			/*properties:{
				// Содержимое балуна.
